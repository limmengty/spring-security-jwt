...
import com.ms.spring_security_jwt.infrastructure.annotation.ApiBearerAuthConfig;
...
public class SwaggerOpenApiConfig {
    ...
    private String[] getBackendPackagesToScan() {
        return new String[]{"com.ms.spring_security_jwt.modules.user.controller.backend"};
    }

    private String[] getFrontendPackagesToScan() {
        return new String[]{"com.ms.spring_security_jwt.modules.user.controller.frontend"};
    }
